...
if(isset($_POST['ced_sadc_save']))
{
	...
	update_option(CED_SADC_PREFIX.'settings', $sadc_setting);  //CED_SADC_PREFIX is define in main file
}
		...
		<tbody>
			...
			<tr valign="top">
				<th class="titledesc" scope="row" colspan="2">
					<label><?php _e('Additional cost for days','shipping-delivery-date-management-with-gift-message');?></label>
					<hr/>
			...
			<tr valign="top">
				<th class="titledesc" scope="row" colspan="2">
					<label><?php _e('Adjust Padding for Gift Message Box in the Product Single Page','shipping-delivery-date-management-with-gift-message');?></label>
					<hr/>
					<table>
						<label><?php _e('Enter the gift box padding in pixels','shipping-delivery-date-management-with-gift-message');?></label>
						<tr>
							<td>
